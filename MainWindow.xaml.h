...
namespace winrt::Winui3_Pen::implementation
{
    struct MainWindow : MainWindowT<MainWindow>
    {
        ...
        void VisibleClick(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e);
    };
}

namespace winrt::Winui3_Pen::factory_implementation
{
